...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    MOINS = 262,                   /* MOINS  */
    EQUAL = 263,                   /* EQUAL  */
    INFERIEUR = 264,               /* INFERIEUR  */
    SUPERIEUR = 265,               /* SUPERIEUR  */
    SUPERIEUR_OU_EQUAL = 266,      /* SUPERIEUR_OU_EQUAL  */
    INFERIEUR_OU_EQUAL = 267,      /* INFERIEUR_OU_EQUAL  */
    PARENTHESE_OUVRANTE = 268,     /* PARENTHESE_OUVRANTE  */
    PARENTHESE_FERMANTE = 269,     /* PARENTHESE_FERMANTE  */
    POINT_VIRGULE = 270,           /* POINT_VIRGULE  */
    ENTIER = 271,                  /* ENTIER  */
    ECRIRE = 272,                  /* ECRIRE  */
    SI = 273,                      /* SI  */
    SINON = 274,                   /* SINON  */
